package app.jerboa.freetypeandroid.utils
...
fun glBufferStatus(): Int {
    ...
    when(e){
        gl3.GL_FRAMEBUFFER_UNDEFINED -> {
            throw RuntimeException("GL_FRAMEBUFFER_UNDEFINED")}
        gl3.GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT -> {throw RuntimeException("GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT")}
        gl3.GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT -> {throw RuntimeException("GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT")}
        gl3.GL_FRAMEBUFFER_UNSUPPORTED -> {throw RuntimeException("GL_FRAMEBUFFER_UNSUPPORTED")}
        gl3.GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE -> {throw RuntimeException("GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE")}
    }
    return e
}
